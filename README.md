...
Changing $\phi_1$ and $\phi_2$ shifts the angular positions of the
velocity fluctuations generated by the following Cardan joints.

The phase angles therefore control how the individual joint
fluctuations combine in the final output-speed response. When an
accelerating contribution from one joint coincides with a decelerating
contribution from another joint, the fluctuations can partially
compensate for one another.

This mechanism is referred to as **kinematic phase compensation**. It
does not represent physical damping or energy dissipation. The reduction
in output-speed unevenness results only from the relative phase and
geometric interaction of the consecutive Cardan joints.
