"""Beginner-friendly Streamlit interface for Cardan Joint Engineering Tool v2.1.2."""
...
st.set_page_config(
    page_title="Cardan Joint Engineering Tool v2.1.2",
    page_icon="⚙️",
    layout="wide",
...
def _excel_workbook(
    ...
    workbook.set_properties({
        ...
        "author": "Furkan Kasap",
        "comments": "Generated by Cardan Joint Engineering Tool v2.1.2",
    })
    ...
    summary_rows = [
        ...
        ("Sürüm" if language_code == "tr" else "Version", "2.1.2", value_fmt),
